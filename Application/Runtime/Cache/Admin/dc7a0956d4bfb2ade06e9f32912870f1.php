...
<div class="pad-10" >
     <input type="hidden" id="delete" value="<?php echo U('Ad/deletebot');?>" />
    ...
    <table width="100%" cellspacing="0">
        ...
        <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$val): $mod = ($i % 2 );++$i;?><tr>
        	...
        	<td align="center"><a href="<?php echo U('Ad/editbot?id='.$val['id']);?>">修改</a></td><?php endforeach; endif; else: echo "" ;endif; ?>
    	</tbody>
    </table>
