...
<body>
  ...
  <div id="div_setting_1" class="contentList pad-10">
    <table width="100%" cellpadding="2" cellspacing="1" class="table_form">
       ...
       <tr>
           <td>是否团队参观<span>*</span> </td>
           <td  colspan="2"><?php echo $user['is_group']== 0 ? '否' : '是' ;?></td>
       </tr>
       <tr>
           <td>团队人数<span>*</span> </td>
           <td  colspan="2"><?php echo ($user['visitor_num']); ?></td>
       </tr>
        <tr>
      ...
      <tr>
       ...
       <tr>
           ...
           <td  colspan="2"><?php echo (date("Y-m-d H:i:s",$user['add_time'])); ?></td>
       </tr>
    </table>
  </div>
  ...
  <div class="bk15"></div>
  <div class="btn">
    <a href="<?php echo U('Visit/list_c');?>"><input type="button" value="返回" name="submit" class="button" id="submit"></a>
  </div>
