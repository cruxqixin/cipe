...
$(function(){
	$("[name=delete]").click(function(){
		$("form").attr("action","<?php echo U('Catgory/ligdelete');?>");
		$("form").submit();
	})
})
</script>
...
<div class="pad-lr-10" >
   <form id="myform" name="myform" action="<?php echo U('Catgory/light');?>" method="get" >
    ...
    <table width="100%" cellspacing="0">
        ...
        <?php if(is_array($manu)): $i = 0; $__LIST__ = $manu;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$val): $mod = ($i % 2 );++$i;?><tr>
           ...
           <td align="center"><?php echo (themekind($val["type"])); ?></td>
            <td align="center"><a class="blue" href="<?php echo U('Catgory/lightEdit',array('id'=>$val['id']));?>">编辑</a></td>
