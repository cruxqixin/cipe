...
$(function(){
	  $("#addBbs").click(function(){
		  var key = $(".bbsName").size()+1;
		  var name = "";
		  name += "<input type=\"text\" name=\"bbs[j"+key+"][name]\" class=\"input-text bbsName\" size=\"12\">";
		  var link = "";
		  link += "<input type=\"text\" name=\"bbs[j"+key+"][link]\" class=\"input-text bbsLink\" size=\"12\">";
...
<form action="<?php echo U('Catgory/actEdit');?>" method="post" name="myform" id="myform" enctype="multipart/form-data" style="margin-top:10px;">
  <div class="pad-10">
  <div class="col-tab">
  ...
  <div id="div_setting_1" class="contentList pad-10">
    <table width="100%" cellpadding="2" cellspacing="1" class="table_form">
      ...
      <tr><td>
		...
		<td id="BBSNAME">
		<?php if(is_array($bbs)): $i = 0; $__LIST__ = $bbs;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$bb): $mod = ($i % 2 );++$i;?><input type="text" name="bbs[h<?php echo ($i); ?>][name]" class="input-text bbsName" size="12" value="<?php echo ($bb["bbsname"]); ?>"><?php endforeach; endif; else: echo "" ;endif; ?>
		</td>
		</tr>
		<tr>
		<th>
		...
		<td id="BBSLINK">
		<?php if(is_array($bbs)): $i = 0; $__LIST__ = $bbs;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$bb): $mod = ($i % 2 );++$i;?><input type="text" name="bbs[h<?php echo ($i); ?>][link]" class="input-text bbsLink" size="12" value="<?php echo ($bb["bbslink"]); ?>"><?php endforeach; endif; else: echo "" ;endif; ?>
		</td>
		</tr>
		<tr>
		<th width="100">&nbsp;</th>
