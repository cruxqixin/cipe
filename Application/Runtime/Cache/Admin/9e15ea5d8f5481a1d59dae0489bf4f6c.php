...
<body>
<div class="pad_10">
<form action="<?php echo U('Media/cateEdit');?>" method="post" name="myform" id="myform" enctype="multipart/form-data" style="margin-top:10px;">
  <div class="pad-10">
  <div class="col-tab">
  ...
  <div id="div_setting_1" class="contentList pad-10">
    ...
    <tr>
      <th width="100">分类 :</th>
      <td><input type="text" name="title" id="title" class="input-text" value="<?php echo ($art["title"]); ?>"></td>
    </tr>
