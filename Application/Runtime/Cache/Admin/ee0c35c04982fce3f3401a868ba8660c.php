...
<div class="pad-10" >
    <form name="searchform" action="<?php echo U('Travel/index');?>" method="get" >
    ...
    <table width="100%" cellspacing="0">
        ...
        <?php if(is_array($articles)): $i = 0; $__LIST__ = $articles;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$val): $mod = ($i % 2 );++$i;?><tr>
           ...
           <td align="center" style="padding-left:50px;"><a href="<?php echo U('Travel/edit',array('id'=>$val['id']));?>">修改</a>&nbsp;&nbsp;</td><?php endforeach; endif; else: echo "" ;endif; ?>
    	</tbody>
    </table>
