...
$(function(){
	$("#search").click(function(){
		$("#myform").attr("action","<?php echo U('Activityy/index');?>");
	})
})
</script>
...
<div class="pad-10" >
     <input type="hidden" id="delete" value="<?php echo U('Activityy/delete');?>" />
    ...
    <table width="100%" cellspacing="0">
        ...
        <?php if(is_array($articles)): $i = 0; $__LIST__ = $articles;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$val): $mod = ($i % 2 );++$i;?><tr>
        	...
        	<td align="center"><a href="<?php echo U('Activityy/edit?id='.$val['id']);?>">修改</a></td><?php endforeach; endif; else: echo "" ;endif; ?>
    	</tbody>
    </table>
