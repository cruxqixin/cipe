...
$(function(){
	$("[name=export]").click(function(){
		$("#searchform").attr("action","<?php echo U('Visit/export_be');?>");
		$("#searchform").submit();
	})
})
</script>
...
<div class="pad-10" >
    ...
    <table width="100%" cellspacing="0">
        ...
        <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$val): $mod = ($i % 2 );++$i;?><tr>
            ...
            <td align="center">
            <a href="<?php echo U('Visit/info_be?id='.$val['id']);?>">查看</a>
...
function delete_confirm_submit(agency_id){
	$.post("<?php echo U('Visit/delete_visit');?>", {action: "post" , type : "be" , id : agency_id},function(msg){
		alert('操作成功');
	   	location.reload();
	});
}
