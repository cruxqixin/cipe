...
<div class="pad-10" >
    <form name="searchform" id="searchform" action="<?php echo U('News/index');?>" method="get" >
    ...
    <table width="100%" cellspacing="0">
        ...
        <?php if(is_array($articles)): $i = 0; $__LIST__ = $articles;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$val): $mod = ($i % 2 );++$i;?><tr>
			...
			<td align="center"><?php if($val['type'] == 1): ?>展会新闻<?php elseif($val['type'] == 2): ?>展商速递<?php else: ?>视频报道<?php endif; ?></td>
    ...
    <div class="btn">
    	...
    	<input type="submit" class="button" name="order" onclick="document.searchform.action='<?php echo U('News/order');?>'" value="排序" style="float:left;"/>
