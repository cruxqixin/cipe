...
$(function(){
	$("[name=delete]").click(function(){
			$("[name=searchform]").attr("action","<?php echo U('Theme/delete');?>");
...
<div class="pad-10" >
    <form name="searchform" action="<?php echo U('Theme/index');?>" method="get" >
    ...
    <table width="100%" cellspacing="0">
        ...
        <?php if(is_array($manu)): $i = 0; $__LIST__ = $manu;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$val): $mod = ($i % 2 );++$i;?><tr>
            ...
            <td align="center"><a href="<?php echo U('News/edit',array('id'=>$val['id']));?>"><em style="color:black;"><?php echo ($val["title"]); ?></em></a><?php if($val['url'] != ''): ?><br><a href="<?php echo ($val["url"]); ?>" target=_blank><?php echo ($val["url"]); ?></a><?php endif; ?>&nbsp;&nbsp;</td>
           
            <td align="center"><?php echo (date("Y-m-d H:i:s",$val["addtime"])); ?></td>
			<td align="center"><?php echo (themekind($val["type"])); ?></td>
            <td align="center" style="display:none"><input  type="text" class="input-text-c input-text" value="<?php echo ($val["ord"]); ?>" size="4" name="ORDERS[<?php echo ($val["id"]); ?>]"></td>
           <td align="center" style="padding-left:50px;"><a href="<?php echo U('Theme/edit',array('id'=>$val['id']));?>">修改</a>&nbsp;&nbsp;</td><?php endforeach; endif; else: echo "" ;endif; ?>
    	</tbody>
    </table>
