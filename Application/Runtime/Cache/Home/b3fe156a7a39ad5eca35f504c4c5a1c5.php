...
<li><a  style="margin:9px  26px;"href="http://www.cipeasia.com/theme/24.html">▪&nbsp;国防光电子展</a></li>
  ...
  <div class="newsBoX">
  	...
  	<div class="link02">
    	<ul id="new">
        	<li <?php if($art['type'] == 1): ?>class="current1"<?php endif; ?>><a href="http://www.cipeasia.com/exhibiton.html">展会新闻</a></li>
            <li <?php if($art['type'] == 2): ?>class="current1"<?php endif; ?>><a href="http://www.cipeasia.com/Express.html">展商速递</a></li>
            <li <?php if($art['type'] == 3): ?>class="current1"<?php endif; ?>><a href="http://www.cipeasia.com/video.html">视频报道</a></li>
        </ul><div class="clear"></div>
    </div>
    <div id="new_content">
      <div class="detailBox">
    	 <div class="newsDetail-01">
            <dl>
            	<dd><a>
                    <h1><?php echo ($art['title']); ?></h1></a>
                    <p style="text-align:center">新闻来源：<?php echo ($art['source']); ?>        新闻时间：<?php echo (date("Y-m-d",$art['addtime'])); ?></p></dd>
                <?php echo ($art['info']); ?>
  ...
  <div class="footer">
     <div class="copyright">
     	<p>北京宇航会展有限公司版权所有  京ICP备12003248号 </p>
     </div>
  </div>
</body>
</html>