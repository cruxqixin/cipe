...
<title>下载中心-<?php echo C('site_name');?></title>
...
<li><a  style="margin:9px  26px;"href="http://www.cipeasia.com/theme/24.html">▪&nbsp;国防光电子展</a></li>
  ...
  <div class="newsBoX">
  	<div class="banner01">
    	<a href="#"><img src="/images/down.jpg" /></a>
    </div>
	<div class="downmain">
			
		<ul>
		  <?php if(is_array($pages['data'])): $i = 0; $__LIST__ = $pages['data'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$val): $mod = ($i % 2 );++$i;?><li>
				
				<div class="title1"><?php echo ($val['title']); ?></div>
				<div class="text"><?php echo ($val['desc']); ?></div>
				<a href="<?php echo ($path); ?>/Down/Down/down?file=<?php echo ($val['files']); ?>"><input type="button" class="download" value="点击下载"/></a>
