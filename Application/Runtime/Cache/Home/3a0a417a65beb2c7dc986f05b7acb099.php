...
<title>新闻首页-<?php echo C('site_name');?></title>
...
<li><a  style="margin:9px  26px;"href="http://www.cipeasia.com/theme/24.html">▪&nbsp;国防光电子展</a></li>
  	...
  	<div class="link02">
    	<ul id="new">
        	<li <?php if($_GET['type'] == 1): ?>class="current1"<?php endif; ?>><a href="http://www.cipeasia.com/exhibiton.html">展会新闻</a></li>
            <li <?php if($_GET['type'] == 2): ?>class="current1"<?php endif; ?>><a href="http://www.cipeasia.com/Express.html">展商速递</a></li>
            <li <?php if($_GET['type'] == 3): ?>class="current1"<?php endif; ?>><a href="http://www.cipeasia.com/video.html">视频报道</a></li>
        </ul><div class="clear"></div>
    </div>
    <div id="new_content">
      <div class="detailBox">
    	<ul id="menu1">
		   <?php if(is_array($news1['data'])): $i = 0; $__LIST__ = $news1['data'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$val): $mod = ($i % 2 );++$i;?><li>
            	<div class="showLi">
                   <a target="_blank" href="<?php if($val['type'] == 3): echo ($val['url']); else: ?>http://www.cipeasia.com/News/<?php echo ($val['id']); ?>.html<?php endif; ?>"><img src="<?php if($val['pic'] == ''): ?>/images/news.jpg<?php else: echo ($val["pic"]); endif; ?>" /></a>
                   <div class="text02">
                   	 <h2><?php echo ($val['title1']); ?></h2>
                     <font><?php echo (date("Y-m-d",$val['addtime'])); ?></font>
                     <p><?php echo ($val['info']); ?></p>
                  </div>
				</div>
                <div class="active">
                 <a target="_blank" href="<?php if($val['type'] == 3): echo ($val['url']); else: ?>http://www.cipeasia.com/News/<?php echo ($val['id']); ?>.html<?php endif; ?>">
                   <div class="active-01">
                     <h1><?php echo ($val['title']); ?></h1>
                     <img src="/images/active_05.jpg" />
                   </div>
                 </a>
                </div>
