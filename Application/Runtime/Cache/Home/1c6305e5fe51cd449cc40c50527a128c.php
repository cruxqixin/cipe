  ...
  <div class="themeBox">
    ...
    <div id="menu_content">
      <div class="manufactureBox">
        <div class="banner">
          <img src="<?php echo ($theme['img']); ?>" />
        </div>
        <div class="manufacture01">
            <div class="manufacture01-1">
               <div class="text01">
                  <h1><?php echo ($theme['title']); ?></h1>
                  <p><?php echo (msubstr(strip_tags($theme['desc']),0,70,'utf-8',false)); ?>...</p>
				  <input type="button" id="detail"  value="了解详情" class="detail">
               </div>
               <div class="img01">
                  <dl>
                    <dd><img src="<?php echo ($theme['descimg']); ?>" /></dd>
                    <dt><p><?php echo (msubstr(strip_tags($theme['content']),0,140,'utf-8',false)); ?>...<span style="cursor:pointer" id="detail1">【查看详情】</span></p>
                    </dt>
                  </dl>
               </div>
