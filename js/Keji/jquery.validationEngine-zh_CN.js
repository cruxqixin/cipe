        ...
        newLang: function(){
            $.validationEngineLanguage.allRules = {
				...
				"telphone": {
                    ...
                    "alertText": "* 无效的手机号码或电话号"
                },
                "email": {
                    // Shamelessly lifted from Scott Gonzalez via the Bassistance Validation plugin http://projects.scottsplayground.com/email_address_validation/
                    "regex": /^[a-z0-9_\-\]+[\w\d\u4e00-\u9fff]+(\.[_a-z0-9\-]+)*@([_a-z0-9\-]+\.)+([a-z]{2}|aero|arpa|biz|com|coop|edu|gov|info|int|jobs|mil|museum|name|nato|net|org|pro|travel)$/ ,						
                    "alertText": "* 邮件地址无效"
                },				
				"keyword": {
                    // credit: jquery.h5validate.js / orefalo
				...
				"ajaxUser": {
                    // remote json service locationindex.php?a=verify&m=Base&g=home
                    "url": "/index.php/Keji/Ajax/Username",
                    // error
					 "extraData": "username=eric",
