...
<div class="mainBox">
    ...
    <div class="joint">
        <ul  id="nTabs2">
            ...
            <li class="currentLi"><a >被拒绝预约</a></li>
 ...
 $i = 0; foreach($scheduleList as $k => $v){ $i++; ?>
                        <tr class="top-tab<?php echo ($i%2+1); ?>">
                            ...
                            <td ><a href="<?php echo U('index/info/'.$v['uid']);?>"><?php echo ($v['accept_name']); ?></a></td>
                            <td><input type="button" class="but2" value="被拒绝" /></td>
                        </tr>
                        <?php } ?>
                    </tbody>
                </table>
