...
<div class="mainBox">
    <div class="main-left">
    	<h5>当前位置： <a href="<?php echo U('index/index');?>">首页</a> ><span> <a href="<?php echo U('index/info/'.$onlineUser['uid']);?>">企业用户详情</a></span> ><span> 产品列表</span></h5>
                ...
                <div class="dx_Productdisplay">
                	<div class="dx_Productdisplay01">
                        ...
                        <div class="dx_Productdisplay03">
                        	<a href="<?php echo U('index/info'.$onlineUser['uid']);?>">返回></a>
                        </div>
                    </div>
