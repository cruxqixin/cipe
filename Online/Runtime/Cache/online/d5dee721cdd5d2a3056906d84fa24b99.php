...
<div class="mainBox">
    ...
    <div class="joint">
        <ul  id="nTabs2">
            ...
            <li class="currentLi"><a >已提交预约</a></li>
 ...
 $i = 0; foreach($scheduleList as $k => $v){ $i++; ?>
                        <tr class="top-tab<?php echo ($i%2+1); ?>">
                            ...
                            <td ><a href="<?php echo U('index/info/'.$v['accept_uid']);?>"><?php echo ($v['accept_name']); ?></a></td>
                            <?php if($v['status'] == 1){ ?>
                            <td><input type="button" class="but2 yellow-but" value="待确认" /></td>
                            <?php }else{ ?>
