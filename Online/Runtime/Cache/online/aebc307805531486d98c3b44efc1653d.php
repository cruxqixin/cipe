    	...
    	<div class="fixnone" style="display:block;">
           ...
           <div class="dx_name">
            ...
            <div class="dx_name01">
                ...
                <div class="dx_name03">
                    <input type="text" name='tag' placeholder='请输入1-3个产品标签或关键字,以空格或逗号分隔' value="" class="dx_text validate[required]" style="width:400px;">
                </div>
            </div>
            <div class="dx_name01">
            	<div class="dx_name02">
                ...
                <div class="logobox01">
	        		...
	        		<input type="hidden" name="pic" id="pic" class=" " size="60" value="" />
                </div>
                <div class=logobox02>
