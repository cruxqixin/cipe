...
function geturl($url){
	...
	if($array[1]=='Home'&&$array[2]=='Theme'){
		$url=$array[0].'/'.'Theme/'.$array[5];
	}
	if($array[2]=='News'&&$array[3]=='index'&&$array[5]=="1.html"){
		$url=$array[0].'/'.'exhibiton.html';
	}
	if($array[2]=='News'&&$array[3]=='index'&&$array[5]=="2.html"){
		$url=$array[0].'/'.'Express.html';
	}
	if($array[2]=='News'&&$array[3]=='index'&&$array[5]=="3.html"){
		$url=$array[0].'/'.'video.html';
	}
	if($array[2]=='News'&&$array[3]=='details'){
		$url=$array[0].'/'.'News/'.$array[5];
	}
	if($array[2]=='Visit'&&$array[3]=='index'&&$array[5]=="1.html"){
		$url=$array[0].'/'.'register.html';
	}
	if($array[2]=='Theme2'&&$array[3]=='index'&&$array[5]=="25.html"){
		$url=$array[0].'/'.'opticalfiber.html';
	}
	if($array[2]=='Theme2'&&$array[3]=='index'&&$array[5]=="27.html"){
		$url=$array[0].'/'.'optical.html';
	}
	if($array[2]=='Visit'&&$array[3]=='index'&&$array[5]=="2.html"){
		$url=$array[0].'/'.'LaunchTime.html';
	}
	if($array[2]=='Visit'&&$array[3]=='index'&&$array[5]=="3.html"){
		$url=$array[0].'/'.'TrafficGuidance.html';
	}

	if($array[2]=='Visit'&&$array[3]=='index'&&$array[5]=="10.html"){
		$url=$array[0].'/'.'meiti.html';
	}


	if($array[2]=='Visit'&&$array[3]=='apply'&&$array[5]=="4.html"){
		$url=$array[0].'/'.'apply.html';
	}
	if($array[2]=='Visit'&&$array[3]=='apply'&&$array[5]=="5.html"){
		$url=$array[0].'/'.'manual.html';
	}
	if($array[2]=='Visit'&&$array[3]=='apply'&&$array[5]=="6.html"){
		$url=$array[0].'/'.'BoothMap.html';
	}
	if($array[1]=='Home'&&$array[2]=='Visit'&&$array[3]=='apply'&&$array[5]=="7.html"){
		$url=$array[0].'/'.'directory.html';
	}
	if($array[1]=='Home'&&$array[2]=='Visit'&&$array[3]=='apply'&&$array[5]=="8.html"){
		$url=$array[0].'/'.'Consultation.html';
	}
	if($array[1]=='Home'&&$array[2]=='Visit'&&$array[3]=='apply'&&$array[5]=="9.html"){
		$url=$array[0].'/'.'Build.html';
	}
	if($array[1]=='Home'&&$array[2]=='Activitys'&&$array[3]=='index.html'){
		$url=$array[0].'/'.'Activity.html';
	}
	if($array[2]=='Download'&&$array[3]=='index.html'){
		$url=$array[0].'/'.'Download.html';
	}
	if($array[2]=='Index'&&$array[3]=='media.html'){
		$url=$array[0].'/'.'medias.html';
	}
	if($array[2]=='Index'&&$array[3]=='business.html'){
		$url=$array[0].'/'.'business.html';
	}
	if($array[2]=='Index'&&$array[3]=='about.html'){
		$url=$array[0].'/'.'about.html';
	}
    return $url;
}
/**
